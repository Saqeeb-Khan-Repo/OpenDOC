import{x as l}from"./index-ObDlygTz.js";function n(e,t,o){const a=new Blob([e],{type:o}),i=URL.createObjectURL(a),r=document.createElement("a");r.href=i,r.download=t,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)}function c(e,t){const o=l(t);n(o,`${e}.txt`,"text/plain")}function g(e,t){const o=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
