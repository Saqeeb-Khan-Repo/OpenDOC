import{P as n,p as o,q as i,E as e}from"./index-BZGOZ1KB.js";import{R as t}from"./ResumeEngine-DSUE-Inz.js";const r=[{id:"academic-project-report",title:"University Project Report (B.Tech / MCA / M.Tech)",category:"project",mode:"document",description:"Complete academic project report with Cover Page, Certificate, Declaration, TOC, System Design, Implementation, and IEEE References.",emoji:"🎓",color:"#2563EB",badge:"Standard Academic Presets",initialDocument:{title:"Final Year Major Project Report",mode:"document",pageSettings:{...n.createDefaultSettings(),headerText:"Department of Computer Science & Engineering",footerText:"Final Year Project Report 2026",pageNumberFormat:"arabic",differentFirstPage:!0},coverPageData:{universityName:"VISVESVARAYA TECHNOLOGICAL UNIVERSITY, BELAGAVI",collegeName:"DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING",departmentName:"School of Computing & Information Technology",projectTitle:"AI-POWERED COLLABORATIVE DOCUMENT & REPORT STUDIO",projectSubtitle:"A Scalable Web Architecture for Multi-Format Engineering Documentation",studentName:"Saqeeb Khan & Team",studentUSN:"1CR21CS101, 1CR21CS102",guideName:"Dr. John Doe, Ph.D.",guideDesignation:"Professor & Head of Department",academicYear:"2025 – 2026",submissionDate:"August 2026"},content:`
      ...
      `}},{id:"ieee-research-paper",title:"Academic Research Paper (IEEE Style)",category:"academic",mode:"document",description:"Two-column academic research paper format with abstract, methodology, equations, and IEEE citations.",emoji:"🔬",color:"#059669",initialDocument:{title:"A Novel Architecture for Client-Side Document Processing",mode:"document",pageSettings:{...n.createDefaultSettings(),columns:2,headerText:"IEEE TRANSACTIONS ON COMPUTATIONAL PRODUCTIVITY, VOL. 14, 2026",footerText:"OpenDoc Studio Open Research"},content:`
      ...
      `}},{id:"modern-tech-resume",title:"Modern Software Engineer Resume & CV",category:"career",mode:"document",description:"ATS-friendly modern resume template with summary, skills matrix, experience, projects, and education.",emoji:"💼",color:"#0284C7",initialDocument:{title:"Saqeeb Khan — Resume",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:15,right:15,bottom:15,left:15},showPageNumbers:!1},content:`
      ...
      `}},{id:"startup-pitch-deck",title:"Startup Pitch Deck (10 Slides)",category:"presentation",mode:"presentation",description:"10-slide PowerPoint-style presentation covering problem, solution, market size, business model, and product architecture.",emoji:"📊",color:"#8B5CF6",badge:"16:9 Presentation",initialDocument:{title:"OpenDoc Studio — Seed Pitch Deck",mode:"presentation",presentationSettings:o.createDefaultSettings(),slides:[o.createSlide("title",i[1]),o.createSlide("title-content",i[1]),o.createSlide("two-columns",i[1]),o.createSlide("quote",i[1]),o.createSlide("closing",i[1])]}},{id:"certificate-of-achievement",title:"Certificate of Excellence & Completion",category:"design",mode:"design",description:"Canva-style visual certificate with ornamental borders, recipient name, gold seal badge, and signature placeholders.",emoji:"🏆",color:"#D97706",badge:"Visual Design Canvas",initialDocument:{title:"Certificate of Excellence",mode:"design",canvasWidth:840,canvasHeight:594,canvasBackground:"#FDFBF7",designElements:[e.createElement("shape",{shapeType:"rectangle",transform:{x:20,y:20,width:800,height:554,rotation:0},style:{fill:"transparent",stroke:"#D97706",strokeWidth:3,strokeStyle:"solid",cornerRadius:4}}),e.createElement("shape",{shapeType:"rectangle",transform:{x:30,y:30,width:780,height:534,rotation:0},style:{fill:"transparent",stroke:"#F59E0B",strokeWidth:1,strokeStyle:"dashed",cornerRadius:2}}),e.createElement("text",{transform:{x:80,y:60,width:680,height:70,rotation:0},content:'<h1 style="text-align: center; color: #78350F; font-size: 32px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase;">CERTIFICATE OF EXCELLENCE</h1>',style:{fontFamily:"Georgia",textAlign:"center"}}),e.createElement("text",{transform:{x:120,y:140,width:600,height:40,rotation:0},content:'<p style="text-align: center; color: #92400E; font-size: 16px; font-style: italic;">THIS CERTIFICATE IS PROUDLY PRESENTED TO</p>',style:{fontFamily:"Georgia",textAlign:"center"}}),e.createElement("text",{transform:{x:80,y:190,width:680,height:60,rotation:0},content:'<h2 style="text-align: center; color: #1E3A8A; font-size: 36px; font-weight: bold; border-bottom: 2px solid #F59E0B; padding-bottom: 8px;">Saqeeb Khan</h2>',style:{fontFamily:"Georgia",textAlign:"center"}}),e.createElement("text",{transform:{x:100,y:280,width:640,height:80,rotation:0},content:'<p style="text-align: center; color: #334155; font-size: 15px; line-height: 1.6;">For exceptional performance, innovation, and outstanding contributions in the engineering of OpenDoc Studio during the 2026 Academic Year.</p>',style:{fontFamily:"Inter",textAlign:"center"}}),e.createElement("text",{transform:{x:100,y:440,width:240,height:70,rotation:0},content:'<p style="text-align: center; border-top: 1px solid #64748b; padding-top: 8px; font-size: 14px; font-weight: 600; color: #0f172a;">August 16, 2026<br/><span style="font-size: 12px; color: #64748b; font-weight: normal;">Date of Issuance</span></p>',style:{textAlign:"center"}}),e.createElement("text",{transform:{x:500,y:440,width:240,height:70,rotation:0},content:'<p style="text-align: center; border-top: 1px solid #64748b; padding-top: 8px; font-size: 14px; font-weight: 600; color: #0f172a;">Dr. John Doe, Ph.D.<br/><span style="font-size: 12px; color: #64748b; font-weight: normal;">Director & Program Head</span></p>',style:{textAlign:"center"}})]}},{id:"event-marketing-flyer",title:"Event & Conference Marketing Flyer",category:"design",mode:"design",description:"Freeform marketing flyer with bold headers, feature highlights, badge shapes, and integrated QR code.",emoji:"📢",color:"#EC4899",badge:"Marketing Flyer",initialDocument:{title:"Tech Conference 2026 Flyer",mode:"design",canvasWidth:600,canvasHeight:800,canvasBackground:"#0F172A",designElements:[e.createElement("shape",{shapeType:"rounded-rectangle",transform:{x:30,y:30,width:540,height:740,rotation:0},style:{fill:"#1E293B",stroke:"#3B82F6",strokeWidth:2,cornerRadius:16}}),e.createElement("text",{transform:{x:50,y:60,width:500,height:100,rotation:0},content:'<h1 style="color: #60A5FA; font-size: 32px; font-weight: bold; text-align: center; margin: 0;">GLOBAL TECH SUMMIT 2026</h1><p style="color: #94A3B8; font-size: 16px; text-align: center; margin-top: 8px;">The Future of Document Intelligence & Web AI</p>',style:{textAlign:"center"}}),e.createElement("qrcode",{transform:{x:220,y:560,width:160,height:160,rotation:0},qrData:{text:"https://opendoc-studio.example.com",fgColor:"#000000",bgColor:"#FFFFFF",margin:2}}),e.createElement("text",{transform:{x:60,y:725,width:480,height:40,rotation:0},content:'<p style="color: #38BDF8; font-size: 13px; text-align: center; font-weight: 600;">Scan QR Code to Register Online • Limited Seats</p>',style:{textAlign:"center"}})]}},{id:"resume-modern-pro",title:"Modern Professional Resume (ATS-Friendly)",category:"career",mode:"document",description:"Clean single-column layout with subtle dividing lines. Optimized for applicant tracking systems and corporate roles.",emoji:"📄",color:"#2563EB",badge:"ATS-Friendly",initialDocument:{title:"Alex Chen — Professional Resume",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:18,right:18,bottom:18,left:18},headerText:"",footerText:""},content:t.renderTemplate(t.getDefaultResumeData(),"tmpl_modern_pro")}},{id:"resume-two-column",title:"Modern Two-Column Layout Resume",category:"career",mode:"document",description:"Compact sidebar for contact info, skills, and languages with expansive experience and project column.",emoji:"📑",color:"#0F172A",badge:"Two-Column",initialDocument:{title:"Alex Chen — Two-Column Resume",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:16,right:16,bottom:16,left:16},headerText:"",footerText:""},content:t.renderTemplate(t.getDefaultResumeData(),"tmpl_two_column")}},{id:"resume-software-eng",title:"Software Engineer & Full-Stack Developer",category:"career",mode:"document",description:"Developer-tailored resume with tech stack tags, open-source projects, and quantified architectural achievements.",emoji:"💻",color:"#059669",badge:"Tech & Engineering",initialDocument:{title:"Alex Chen — Software Engineer CV",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:18,right:18,bottom:18,left:18},headerText:"",footerText:""},content:t.renderTemplate(t.getDefaultResumeData(),"tmpl_software_eng")}},{id:"resume-graduate-fresher",title:"Graduate / Fresher Academic Resume",category:"career",mode:"document",description:"Academic-focused template highlighting degree, GPA, capstone projects, internships, and hackathon honors.",emoji:"🎓",color:"#7C3AED",badge:"Students & Grads",initialDocument:{title:"Alex Chen — Graduate Resume",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:18,right:18,bottom:18,left:18},headerText:"",footerText:""},content:t.renderTemplate(t.getDefaultResumeData(),"tmpl_graduate_fresher")}},{id:"resume-executive-corp",title:"Executive & Corporate Leadership Resume",category:"career",mode:"document",description:"Sophisticated serif typography emphasizing strategic management, board experience, and P&L achievements.",emoji:"👔",color:"#9F1239",badge:"Executive",initialDocument:{title:"Alex Chen — Executive Profile",mode:"document",pageSettings:{...n.createDefaultSettings(),margins:{top:20,right:20,bottom:20,left:20},headerText:"",footerText:""},content:t.renderTemplate(t.getDefaultResumeData(),"tmpl_executive_corp")}}];class p{static getTemplates(){return r}static getTemplateById(a){return r.find(s=>s.id===a)}static getCategories(){return["All","career","project","academic","presentation","design","business"]}}export{p as T};
